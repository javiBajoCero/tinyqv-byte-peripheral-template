...
module tt_um_impostor_WS2812b (
    input         CLK12MHZ,          // Clock - the TinyQV project clock is normally set to 64MHz.
    input         rst_n,        // Reset_n - low to reset.

    input  DIN,        // The input PMOD, always available.  Note that ui_in[7] is normally used for UART RX.
                                // The inputs are synchronized to the clock, note this will introduce 2 cycles of delay on the inputs.

    output DOUT,       // The output PMOD.  Each wire is only connected if this peripheral is selected.
